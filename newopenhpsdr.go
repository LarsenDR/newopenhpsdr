// Package newopenhpsdr to interface with the openHPSDR Protocol 2 Radio Boards
// Using the new protocol
// by Dave Larsen KV0S, May 3, 2014
// CRC added, by Rick N1GP, March 20, 2019
// GPL2
//
...
//Hpsdrboardtable function to format Hpsdrboard struct for web output
...
// Hpsdrboardlist function to format Hpsdrboard struct for web output
...
// Atlasboardstable function to format Hpsdrboard struct for web output
func Atlasboardstable(brd Hpsdrboard) (str string) {
	str = fmt.Sprintf("%#v\n<br/>", brd)
	return str
}

// ResetHpsdrboard function to reset the Hpsdrboard to no value
...
// Interfaces function to determine the network interfaces connect to this machine.
...
// Commlink function setup a communications link
...
// Commpacketsend  function to sens a packet to the board
...
//Commpacketreceive function to receive packets from the board
...
// Makepacket is a function to make the next packet to send to the board
...
// Makepacketprogram function to make programming packets
...
//Discover function sends the Discovery packet to an interface.
...
//Setip function to send the Set IP packet to an interface.
...
//Erase functions to send the Erase packet to an interface.
...
//Erasenew function to send the New Erase packet to an interface.
...
//Erasefunc function to send and receive the Erase Packets.
...
// Lapstime  functions to counter time using a channel
...
// Checksum function to test the complete packet arrived
func Checksum() uint16 {
	return nchk
}

//Program function to send the Program packets to an interface.
